...
module.exports = {
  ...
  execute (message, args) {
    const embed = new Discord.MessageEmbed()
      ...
      .setTitle('UNAL')
      .setDescription('Bot de Discord de la Universidad Nacional de Colombia.\n[Vota en top.gg](https://top.gg/bot/780526166561521716/vote)\n[Vota en DBL](https://discordbotlist.com/bots/unal/upvote)')
      .addFields(
        ...
        { name: 'Invitación', value: '[Link de invitación](https://discord.com/api/oauth2/authorize?client_id=780526166561521716&permissions=453696&scope=bot).' }
      )
